	...
	<div class="settings">
		<div class="acf-field-editor">
			<div class="acf-field-settings acf-fields">
				...
				<?php
					$tabs = [
						'general', 'validation', 'presentation', 'conditional-logic', 'shortcode',
					];
				...
				<div class="acf-field-settings-main acf-field-settings-main-shortcode">
				<?php
					if( ! $parent ){
				...
				?>
				</div><!-- /.acf-field-settings-main-shortcode -->
