...
if ( !class_exists( 'Front_End_Admin' ) ) {
    ...
    final class Front_End_Admin
    {
        ...
        {
            if(  did_action( 'front_end_admin_pro_loaded' ) ) return;

            global $fea_instance;

            if( isset( $fea_instance ) ) return;
        ...
        {
            require_once( 'main/helpers/data-fetch.php' );
            require_once( 'main/helpers/addon-installer.php' );
            require_once( 'main/helpers/permissions.php' );	
